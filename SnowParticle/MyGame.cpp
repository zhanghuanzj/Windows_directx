...
void Print(int x,int y,string text,D3DCOLOR color=D3DCOLOR_XRGB(255,255,255))
{
	RECT rect = {x,y,SCREENW,SCREENH};
	font->DrawTextA(nullptr,text.c_str(),-1,&rect,DT_TOP | DT_LEFT, color);
}
...
bool Game_Init(HWND window)
{
	...
	//new initialize.......................................................................
	//font
	D3DXCreateFont(d3ddev, 36, 0, 0, 1000, false, DEFAULT_CHARSET, 
		OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, 0, "Times New Roman", &font);
	if (font==nullptr)
	{
		MessageBox(window, "Error initializing MyFont", APPTITLE.c_str(), 0);
		return false;
	}
	...
	//snow
	mySnow = new SnowParticle(d3ddev);
	mySnow->InitSnowParticle();
...
void Game_Run(HWND window)
{
	...
	if (timeGetTime() > screentimer + 14)
	{
		...
		{		
			...
			//
			mySnow->UpdateSnowParticle(timeDelay);
			mySnow->RenderSnowParticle();
			//font
			Print(0,0,"jack is coming");
